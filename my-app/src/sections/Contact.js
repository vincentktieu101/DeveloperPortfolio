    ...
    <div id="contact">
      <Container>
        ...
        <div className="flex-space-around">
          <form>
            <TextField label="Name" variant="outlined" style={{width: "100%", marginBottom: "5px"}} />
            <TextField label="Contact" variant="outlined" style={{width: "100%", marginBottom: "5px"}} />
            <TextField label="Write Anything You'd Like!" variant="outlined" multiline rows={3} style={{width: "100%", marginBottom: "5px"}} />
            <Button variant="contained" color="primary" style={{width: "100%", marginBottom: "5px"}}>Submit</Button>
            <br />
            <br />
          </form>
          <div>
